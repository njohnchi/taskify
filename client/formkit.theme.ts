...
/**
  ...
  *
  * @checksum - d4c545910d0e97235db6f616f2fcb4a235b2fce7d72c9954782aa2eb5c007a68
  * @variables - radius=rounded-lg,accentColor=blue,colorTemperature=slate,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
